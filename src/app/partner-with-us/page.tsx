      ...
      <section className="bg-white" aria-labelledby="imagine-heading">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-[#F9FAFB] flex flex-col justify-center px-10 py-16 lg:px-16">
            <h2 id="imagine-heading" className="text-3xl sm:text-4xl font-bold text-[#1B2A3D] leading-tight">
            ...
            <Link
              href="#partner-form"
              className="inline-flex items-center gap-2 mt-8 px-8 py-4 bg-[#5C7A94] hover:bg-[#7A96AC] text-white font-bold rounded-full transition-all duration-200 text-sm w-fit"
            >
              Enquire Now
            </Link>
          </div>
