  ...
  return (
    <>
      ...
      <section className="py-24 bg-[#F9FAFB]" aria-labelledby="universities-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[#C8953C] font-semibold text-sm uppercase tracking-widest mb-2">
              Independent Research
            </p>
            <h2 id="universities-heading" className="text-3xl font-bold text-[#0D1B3E]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {universities.map(({ name, study, detail }) => (
              <div
                key={name}
                className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:border-[#C8953C]/20 hover:shadow-md transition-all duration-300"
              >
                <div className="text-xs font-bold text-[#C8953C] uppercase tracking-widest mb-2">{name}</div>
                <h3 className="text-lg font-bold text-[#0D1B3E] mb-3">{study}</h3>
      ...
      <section className="py-24 bg-white" aria-labelledby="aging-heading">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 id="aging-heading" className="text-3xl font-bold text-[#0D1B3E]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 overflow-x-auto">
              <table className="w-full text-sm" aria-label="Aging clock correlations with Prysm Score">
                <thead>
                  <tr className="bg-[#0D1B3E] text-white text-left">
                ...
                <tbody>
                  {agingClocks.map(({ clock, r, p, direction }, i) => (
                    ...
                    >
                      <td className="px-5 py-3 font-medium text-[#0D1B3E]">{clock}</td>
                      <td className="px-4 py-3 text-center font-bold text-[#C8953C]">{r}</td>
            ...
            <div className="bg-[#0D1B3E] rounded-2xl p-6 text-white">
              <p className="text-[#C8953C] text-xs font-bold uppercase tracking-widest mb-2">Tertile Comparison</p>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#C8953C] shrink-0" />
          ...
          <div className="mt-8 border border-gray-200 rounded-2xl p-6 bg-[#F9FAFB]">
            <p className="text-xs font-bold text-[#C8953C] uppercase tracking-widest mb-2">Verdict</p>
      ...
      <section className="bg-[#F9FAFB] py-24" aria-labelledby="systems-heading">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 id="systems-heading" className="text-3xl font-bold text-[#0D1B3E]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {bodySystems.map(({ rank, system, years }) => (
              ...
              >
                <span className="w-8 h-8 rounded-full bg-[#0D1B3E] text-white text-xs font-bold flex items-center justify-center shrink-0">
                  {rank}
                </span>
                <span className="flex-1 font-medium text-[#0D1B3E]">{system}</span>
                <span className="px-4 py-1.5 bg-[#0D1B3E] text-white text-sm font-bold rounded-lg">
                  {years}
                </span>
              </div>
            ))}
          ...
          <div className="mt-8 bg-[#0D1B3E] rounded-2xl px-8 py-6 text-white text-center">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <svg className="w-10 h-10 text-[#C8953C]/30 mx-auto mb-6" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
          ...
          <p className="mt-6 text-sm font-semibold text-[#0D1B3E]">Stanford Medicine</p>
