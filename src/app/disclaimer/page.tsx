...
export default function DisclaimerPage() {
  return (
    <>
      ...
      <div className="bg-[#5C7A94]/10 border-b border-[#5C7A94]/20 py-5">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 flex items-start gap-3">
          <svg className="w-5 h-5 text-[#5C7A94] shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500 text-sm">
              ...
              <Link href="/terms" className="text-[#5C7A94] hover:underline font-medium">
                View our Terms of Service
              </Link>{" "}
              or{" "}
              <Link href="/privacy-policy" className="text-[#5C7A94] hover:underline font-medium">
                Privacy Policy
              </Link>.
            </p>
          </div>
